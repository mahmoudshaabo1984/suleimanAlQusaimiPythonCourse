...
│
└── apps/
    └── channel_name_gen/          # مشروع مستقل: مولّد أسماء القنوات
```

> **ملاحظة:** كل مجلد محاضرة يحتوي على أكواد الدرس وتمارينه وبرامجه النهائية.
...
## 🛠️ المشروع المستقل: مولّد أسماء القنوات
